...
PATH_TO_TRAIN = 'datasets/retailrocket/train_session_3.csv'
PATH_TO_TEST = 'datasets/retailrocket/test_session_3.csv'
...
if __name__ == '__main__':
    ...
    gru = gru4rec.GRU4Rec(loss='top1-max', final_act='tanh', hidden_act='tanh', n_epochs=8, layers=[100], batch_size=64, dropout_p_hidden=0.5, learning_rate=0.2, momentum=0.3, time_sort=False)
    gru.fit(data)
